...
/* harmony import */ var _graphql_queries_get_current_user_graphql__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(46);
...
/* harmony import */ var _graphql_mutations_sign_in_graphql__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(47);
...
/* harmony import */ var _graphql_mutations_sign_up_graphql__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48);
...
var add = __webpack_require__(4).default
module.exports.__inject__ = function (context) {
  add("9c54718e", content, true, context)
};
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".message{position:relative;display:block;flex-shrink:0;min-height:60px;padding:8px 50px 8px 70px;line-height:22px;transition:all .3s ease}.message:hover{background-color:var(--secondary-background)}.message__avatar{position:absolute;top:10px;left:20px;width:40px;height:40px;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border-radius:50%;-o-object-fit:cover;object-fit:cover;-o-object-position:center center;object-position:center center}.message__avatar_type_default{font-size:18px;line-height:40px;text-align:center;text-transform:uppercase;background:hsla(0,0%,100%,.1);border-radius:50%}.message__author-name{display:inline-block;vertical-align:middle;overflow:hidden;max-width:150px;font-size:14px;font-weight:600;white-space:nowrap;text-overflow:ellipsis;cursor:pointer}.message__author-name:hover{text-decoration:underline}.message__header{min-height:22px;font-size:0;white-space:pre-line}.message__timestamp{display:inline;vertical-align:middle;margin-left:8px;color:var(--gray_600);font-size:11px;cursor:default}.message__text{margin:0 0 6px;color:var(--gray_200);word-break:break-word}.message__text:last-child{margin-bottom:0}.message__emoji{vertical-align:bottom;width:24px;height:24px;padding:1px;-o-object-fit:contain;object-fit:contain}.message__body{flex-shrink:0}.message__image{display:block;max-width:80%;height:auto;cursor:pointer;-o-object-fit:cover;object-fit:cover}.message__text{display:block}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".chat{position:relative;overflow-x:hidden;overflow-y:auto;overflow:hidden auto;flex-direction:column-reverse;height:100%;background:var(--primary-background);scroll-behavior:smooth}.chat,.chat__messages{display:flex;width:100%}.chat__messages{position:absolute;justify-content:flex-end;flex-direction:column;min-height:100%}", ""]);
// Exports
module.exports = exports;
...
var ___CSS_LOADER_URL_REPLACEMENT_0___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_0___);
// Module
exports.push([module.i, ".footer{position:relative;display:flex;padding:10px 12px;box-shadow:0 -3px 6px rgba(0,0,0,.16)}.footer__emoji-panel{max-width:376px;height:250px;max-height:250px}.footer__attach-panel,.footer__emoji-panel{position:absolute;left:0;bottom:100%;padding:12px 12px 0}.footer__input-field{overflow:hidden;width:100%;height:32px;padding:0 12px;background-color:var(--secondary-background);border-radius:5px;box-shadow:0 0 6px rgba(0,0,0,.16)}.footer__actions-left,.footer__input-field{position:relative;display:flex;align-items:center;margin-right:12px}.footer__actions-left{flex-shrink:0}.footer__actions-button{display:block;width:24px;height:24px;fill:var(--primary-text);cursor:pointer}.footer__actions-button:hover{fill:var(--accent-text)}.footer__actions-button:not(:last-child){margin-right:8px}.footer__emoji-button{background-image:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ");background-position:0 0;background-size:264px 120px;filter:grayscale(1)}.footer__emoji-button.footer__actions-button_type_active,.footer__emoji-button:hover{filter:grayscale(0)}.footer__attach-button{transform:rotate(225deg)}.footer__attach-button.footer__actions-button_type_active,.footer__attach-button:hover{fill:var(--accent-text)}.footer__input{display:block;flex-grow:1;flex-basis:100%;width:100%;height:100%;margin-right:8px;color:var(--primary-text);background:transparent;border:none;outline:none}.footer__actions-right{display:flex;align-items:center;flex-shrink:0}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".page{--error:#c0392b;--gray_20:#fafafa;--gray_40:#f4f6f5;--gray_50:#ebf0ed;--gray_100:#e1e5e3;--gray_200:#c3cbc7;--gray_300:#a9b2ad;--gray_400:#909894;--gray_500:#757a78;--gray_600:#5c605e;--gray_700:#434645;--gray_800:#2d2f2e;--gray_900:#191a1a;--gray_950:#0a0a0a;--green_100:#ff8b8b;--green_200:#f88;--green_300:#ff6b6b;--green_400:#ff5d5d;--green_500:#ff4c4c;--green_600:#fc2c2c}.page_theme_light{--primary:var(--green_300);--primary-dark:var(--green_500);--primary-text:var(--gray_800);--secondary-text:var(--gray_700);--accent-text:var(--green_300);--contrast-text:var(--gray_100);--primary-background:var(--gray_20);--secondary-background:var(--gray_100);--accent-background:var(--green_600);--contrast-background:var(--gray_950);--input-background:var(--gray_50);--input-border:var(--gray_50);--shadow:rgba(0,0,0,0.14)}.page_theme_dark{--primary:var(--green_400);--primary-dark:var(--green_500);--primary-text:var(--gray_100);--secondary-text:var(--gray_300);--accent-text:var(--green_200);--contrast-text:var(--gray_950);--primary-background:var(--gray_900);--secondary-background:var(--gray_800);--accent-background:var(--green_400);--contrast-background:var(--gray_100);--input-background:var(--gray_800);--input-border:var(--gray_800);--shadow:rgba(0,0,0,0.14)}", ""]);
// Exports
module.exports = exports;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_stylus_loader_index_js_ref_8_oneOf_1_3_aside_footer_styl_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(41);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_stylus_loader_index_js_ref_8_oneOf_1_3_aside_footer_styl_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_stylus_loader_index_js_ref_8_oneOf_1_3_aside_footer_styl_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_stylus_loader_index_js_ref_8_oneOf_1_3_aside_footer_styl_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_stylus_loader_index_js_ref_8_oneOf_1_3_aside_footer_styl_vue_type_style_index_0_lang_stylus___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, ".aside-footer{display:block;width:100%}.aside-footer__profile{display:flex;align-items:center;flex-direction:row-reverse;padding:5px 10px;cursor:pointer;-webkit-user-select:none;-moz-user-select:none;-ms-user-select:none;user-select:none;border-radius:5px;transition:all .3s ease}.aside-footer__profile:hover{background-color:var(--gray_700)}.aside-footer__profile:active{background-color:var(--gray_600)}.aside-footer__profile:last-child{margin-bottom:0}.aside-footer__avatar{flex-shrink:0;width:34px;height:34px;border-radius:50%;-o-object-fit:cover;object-fit:cover}.aside-footer__avatar_type_default{font-size:18px;line-height:34px;text-align:center;text-transform:uppercase;background:hsla(0,0%,100%,.1);border-radius:50%}.aside-footer__username{overflow:hidden;margin-right:10px;font-size:14px;font-weight:400;line-height:20px;white-space:nowrap;text-overflow:ellipsis}", ""]);
// Exports
module.exports = exports;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var apollo_link_error__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(64);
...
const middleware = {};
middleware['authenticated'] = __webpack_require__(70);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/chat/chat.vue?vue&type=template&id=7c57007a&
var chatvue_type_template_id_7c57007a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{ref:"scroll",staticClass:"chat scrollbar"},[_c('b-upload-file'),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"chat__messages\">","</div>",_vm._l((_vm.messages),function(message){return _c('b-message',{key:message.id,attrs:{"message":message.content,"owner":message.owner,"timestamp":message.createdAt,"username":message.username,"pictures":message.pictures}})}),1)],2)}
var chatvue_type_template_id_7c57007a_staticRenderFns = []


// CONCATENATED MODULE: ./components/chat/chat.vue?vue&type=template&id=7c57007a&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/message/message.vue?vue&type=template&id=90b72a80&
var messagevue_type_template_id_90b72a80_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"message"},[_vm._ssrNode(((_vm.avatar)?("<img"+(_vm._ssrAttr("src",_vm.avatar))+" class=\"message__avatar\">"):("<div class=\"message__avatar message__avatar_type_default\""+(_vm._ssrStyle(null,{ backgroundColor: _vm.avatarColor }, null))+">"+_vm._ssrEscape("\n    "+_vm._s(_vm.username[0])+"\n  ")+"</div>"))+" "),_vm._ssrNode("<div class=\"message__content\">","</div>",[_vm._ssrNode("<div class=\"message__header\">","</div>",[_c('router-link',{staticClass:"message__author-name link_no_styles",attrs:{"to":"/"}},[_vm._v(_vm._s(_vm.username))]),_vm._ssrNode(" <time"+(_vm._ssrAttr("datetime",_vm.timestamp))+(_vm._ssrAttr("title",_vm.localDateTimeFull))+" class=\"message__timestamp\">"+_vm._ssrEscape(_vm._s(_vm.localDateTime))+"</time>")],2),_vm._ssrNode(" <div class=\"message__body\"><span class=\"message__text\">"+_vm._ssrEscape(_vm._s(_vm.message))+"</span> "+(_vm._ssrList((_vm.pictures),function(picture){return ("<img"+(_vm._ssrAttr("src",picture.m.link))+(_vm._ssrAttr("width",picture.m.width))+(_vm._ssrAttr("height",picture.m.height))+" class=\"message__image\">")}))+"</div>")],2)],2)}
var messagevue_type_template_id_90b72a80_staticRenderFns = []


// CONCATENATED MODULE: ./components/message/message.vue?vue&type=template&id=90b72a80&
...
function toLocalDateTime(iso) {
  ...
  return date.setLocale('ru').toLocaleString(external_luxon_["DateTime"].DATE_MED);
}
...
var message_component = normalizeComponent(
  ...
  messagevue_type_template_id_90b72a80_render,
  messagevue_type_template_id_90b72a80_staticRenderFns,
  false,
...
var chat_component = normalizeComponent(
  ...
  chatvue_type_template_id_7c57007a_render,
  chatvue_type_template_id_7c57007a_staticRenderFns,
  false,
  chat_injectStyles,
  null,
  "0dcb3db8"
...
var emoji_panelvue_type_template_id_664983ca_staticRenderFns = []


// CONCATENATED MODULE: ./components/emoji-panel/emoji-panel.vue?vue&type=template&id=664983ca&
...
var emoji_panel_component = normalizeComponent(
  ...
  emoji_panelvue_type_template_id_664983ca_render,
  emoji_panelvue_type_template_id_664983ca_staticRenderFns,
  false,
...
var create_message_graphql = __webpack_require__(45);
...
var footer_component = normalizeComponent(
  ...
  footervue_type_template_id_bd9a0550_render,
  footervue_type_template_id_bd9a0550_staticRenderFns,
  false,
  footer_injectStyles,
  null,
  "5986f278"
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=473d435a&
var defaultvue_type_template_id_473d435a_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{directives:[{name:"touch",rawName:"v-touch:swipe.left",value:(_vm.swipeLeft),expression:"swipeLeft",arg:"swipe",modifiers:{"left":true}},{name:"touch",rawName:"v-touch:swipe.right",value:(_vm.swipeRight),expression:"swipeRight",arg:"swipe",modifiers:{"right":true}}],staticClass:"page__wrapper"},[_vm._ssrNode("<div class=\"page__header\"></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("page__main",{
      ...
      }))+">","</aside>",[_c('b-aside-panel')],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page__aside-button page__aside-button_type_mobile\">","</div>",[_c('svg-icon',{staticClass:"page__aside-icon",attrs:{"name":"menu"}})],1),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"page__aside-footer\">","</div>",[_vm._ssrNode("<button class=\"page__aside-menu\">","</button>",[_c('svg-icon',{attrs:{"name":"menu_open"}})],1),_vm._ssrNode(" "),_c('b-aside-footer')],2)],2),_vm._ssrNode(" <div class=\"page__footer\"></div> "),_c('b-modal',{attrs:{"value":_vm.login,"title":"Вход"},on:{"input":_vm.setLogin}},[_c('b-login-modal')],1),_vm._ssrNode(" "),_c('b-modal',{attrs:{"value":_vm.register,"title":"Регистрация"},on:{"input":_vm.setRegister}},[_c('b-register-modal')],1)],2)}
var defaultvue_type_template_id_473d435a_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=473d435a&
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/text-field/text-field.vue?vue&type=template&id=7d9e7c8d&
var text_fieldvue_type_template_id_7d9e7c8d_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('label',{staticClass:"text-field",class:{
...
var text_fieldvue_type_template_id_7d9e7c8d_staticRenderFns = []


// CONCATENATED MODULE: ./components/text-field/text-field.vue?vue&type=template&id=7d9e7c8d&
...
var text_field_component = normalizeComponent(
  ...
  text_fieldvue_type_template_id_7d9e7c8d_render,
  text_fieldvue_type_template_id_7d9e7c8d_staticRenderFns,
  false,
...
var login_modal_component = normalizeComponent(
  ...
  login_modalvue_type_template_id_75a197d5_render,
  login_modalvue_type_template_id_75a197d5_staticRenderFns,
  false,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/register-modal/register-modal.vue?vue&type=template&id=72bb66e4&
var register_modalvue_type_template_id_72bb66e4_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"register-modal"},[_c('b-form',{attrs:{"errors":_vm.errors}},[_c('div',{staticClass:"form__row"},[_c('b-text-field',{attrs:{"id":"register_email","name":"email","placeholder":"E-mail","width-full":""},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.usernameInput.focus()}},model:{value:(_vm.email),callback:function ($$v) {_vm.email=$$v},expression:"email"}})],1),_vm._v(" "),_c('div',{staticClass:"form__row"},[_c('b-text-field',{ref:"usernameInput",attrs:{"id":"register_username","name":"username","placeholder":"Логин","width-full":""},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.passwordInput.focus()}},model:{value:(_vm.username),callback:function ($$v) {_vm.username=$$v},expression:"username"}})],1),_vm._v(" "),_c('div',{staticClass:"form__row"},[_c('b-text-field',{ref:"passwordInput",attrs:{"id":"register_password","name":"password","placeholder":"Пароль","width-full":"","type":"password"},on:{"keydown":function($event){if(!$event.type.indexOf('key')&&_vm._k($event.keyCode,"enter",13,$event.key,"Enter")){ return null; }return _vm.signUp()}},model:{value:(_vm.password),callback:function ($$v) {_vm.password=$$v},expression:"password"}})],1),_vm._v(" "),_c('div',{staticClass:"form__row register-modal__buttons"},[_c('b-button',{staticClass:"register-modal__button",attrs:{"large":""},on:{"click":function($event){return _vm.signIn()}}},[_vm._v("Вход")]),_vm._v(" "),_c('b-button',{staticClass:"register-modal__button",attrs:{"large":""},on:{"click":function($event){return _vm.signUp()}}},[_vm._v("Зарегистрироваться")])],1)])],1)}
var register_modalvue_type_template_id_72bb66e4_staticRenderFns = []


// CONCATENATED MODULE: ./components/register-modal/register-modal.vue?vue&type=template&id=72bb66e4&
...
var register_modal_component = normalizeComponent(
  ...
  register_modalvue_type_template_id_72bb66e4_render,
  register_modalvue_type_template_id_72bb66e4_staticRenderFns,
  false,
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/vue-loader/lib??vue-loader-options!./components/aside-footer/aside-footer.vue?vue&type=template&id=096c1751&
var aside_footervue_type_template_id_096c1751_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"aside-footer"},[_vm._ssrNode("<div class=\"aside-footer__profile\">"+((_vm.avatar)?("<img"+(_vm._ssrAttr("src",_vm.avatar))+" class=\"aside-footer__avatar\">"):("<div class=\"aside-footer__avatar aside-footer__avatar_type_default\""+(_vm._ssrStyle(null,{ backgroundColor: _vm.avatarColor }, null))+">"+_vm._ssrEscape("\n      "+_vm._s(_vm.username[0])+"\n    ")+"</div>"))+" <div class=\"aside-footer__info\"><h3 class=\"aside-footer__username\">"+_vm._ssrEscape(_vm._s(_vm.username))+"</h3></div></div>")])}
var aside_footervue_type_template_id_096c1751_staticRenderFns = []


// CONCATENATED MODULE: ./components/aside-footer/aside-footer.vue?vue&type=template&id=096c1751&
...
var aside_footer_component = normalizeComponent(
  ...
  aside_footervue_type_template_id_096c1751_render,
  aside_footervue_type_template_id_096c1751_staticRenderFns,
  false,
...
var default_component = normalizeComponent(
  ...
  defaultvue_type_template_id_473d435a_render,
  defaultvue_type_template_id_473d435a_staticRenderFns,
  false,
  null,
  null,
  "20cfaf60"
...
(function updateModules() {
  store_store = normalizeRoot(__webpack_require__(121), 'store/index.ts'); // If store is an exported method = classic mode (deprecated)
...
var lodash_clonedeep = __webpack_require__(53);
...
var polyfill_ = __webpack_require__(127);

// EXTERNAL MODULE: external "apollo-client"
var external_apollo_client_ = __webpack_require__(54);
...
var external_apollo_upload_client_ = __webpack_require__(55);
...
var external_subscriptions_transport_ws_ = __webpack_require__(56);

// EXTERNAL MODULE: external "subscriptions-transport-ws/dist/message-types"
var message_types_ = __webpack_require__(57);
var message_types_default = /*#__PURE__*/__webpack_require__.n(message_types_);

// EXTERNAL MODULE: external "apollo-link-ws"
var external_apollo_link_ws_ = __webpack_require__(58);

// EXTERNAL MODULE: external "apollo-utilities"
var external_apollo_utilities_ = __webpack_require__(59);

// EXTERNAL MODULE: external "apollo-link-persisted-queries"
var external_apollo_link_persisted_queries_ = __webpack_require__(60);

// EXTERNAL MODULE: external "apollo-link-context"
var external_apollo_link_context_ = __webpack_require__(61);

// EXTERNAL MODULE: external "apollo-link-state"
var external_apollo_link_state_ = __webpack_require__(62);
...
var external_universal_cookie_ = __webpack_require__(63);
...
var external_vue_functional_data_merge_ = __webpack_require__(65);
...
var external_cookie_universal_ = __webpack_require__(66);
  ...
  const app = {
    head: {
      ...
      "meta": [{
        ...
        "hid": "description",
        "name": "description",
        "content": "Everhoof Instant Messaging System"
      }],
      "link": [{
        "rel": "icon",
        "type": "image\u002Fx-icon",
