...
import nuxt_plugin_snotify_8e8ef7b2 from 'nuxt_plugin_snotify_8e8ef7b2' // Source: ../plugins/snotify.ts (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  if (process.client && typeof nuxt_plugin_snotify_8e8ef7b2 === 'function') {
    await nuxt_plugin_snotify_8e8ef7b2(app.context, inject)
  }
